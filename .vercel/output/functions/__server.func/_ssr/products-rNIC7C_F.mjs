//#region node_modules/.nitro/vite/services/ssr/assets/products-rNIC7C_F.js
var PRODUCTS = [
	{
	...
	},
	{
		...
		metaDescription: "Shop Varagu (Kodo Millet) for a nutritious, fiber-rich traditional grain ideal for healthy and diabetic-friendly meals.",
		structuredData: {
			"@type": "Product",
			name: "Varagu",
			image: ["https://i.ibb.co/dsQkCmpb/varagu.png"],
	...
	},
	{
		...
		metaDescription: "Ordered Saamai (Little Millet) for light, nutritious cooking. Perfect for upma, porridge, and everyday healthy meals.",
		structuredData: {
			"@type": "Product",
			name: "Saamai",
			image: ["https://i.ibb.co/mFbdCP6T/saamai.png"],
	...
	},
	{
		...
		metaDescription: "Buy Kuthiraivali (Barnyard Millet) for a high-fiber, low glycemic grain that supports healthy and weight-conscious diets.",
		structuredData: {
			"@type": "Product",
			name: "Kuthiraivali",
			image: ["https://i.ibb.co/nqSyM3pD/kuthiraivali.png"],
	...
	},
	{
		...
		metaDescription: "Purchase Thinai (Foxtail Millet) for a protein-rich, iron-packed pellet ideal for traditional and modern healthy dishes.",
		structuredData: {
			"@type": "Product",
			name: "Thinai",
			image: ["https://i.ibb.co/v61R0fBS/thinai.png"],
	...
	},
	{
		...
		tamilName: "கம்பு",
		category: "millets",
		description: "A nutritious millet packed with energy, calcium, and iron. Commonly used for porridge, rotis, and wholesome meals.",
		...
		metaDescription: "Order Kambu (Pearl Millet) for a nutrient-packed grain rich in energy, calcium, and iron, perfect for wholesome meals.",
		structuredData: {
			"@type": "Product",
			name: "Kambu",
			image: ["https://i.ibb.co/XxKpmcCT/kambu.png"],
	...
	},
	{
		...
		tamilName: "கேழ்வரகு",
		category: "millets",
		description: "A superfood millet rich in calcium, iron, and dietary fiber. Ideal for babies, children, and adults as part of a balanced diet.",
		...
		metaDescription: "Buy Kelvaragu (Finger Millet) for a calcium-rich superfood millet perfect for all ages and healthy diets.",
		structuredData: {
			"@type": "Product",
			name: "Kelvaragu",
			image: ["https://i.ibb.co/Z1bWPJTn/kelvaragu.png"],
	...
	},
	{
		...
		category: "millets",
		description: "A traditional red rice variety known for its strength-giving properties, rich fiber content, and natural nutrients. Ideal for healthy meals and traditional South Indian cooking.",
		...
		metaDescription: "Shop Mappillai Samba Rice, a traditional red rice rich in fiber and nutrients, perfect for healthy South Indian meals.",
		structuredData: {
			"@type": "Product",
			name: "Mappillai Samba Rice",
			image: ["https://i.ibb.co/dwdfn1cQ/mappillai-samba-rice.png"],
	...
	},
	{
		...
		category: "millets",
		description: "A rare premium black rice variety rich in antioxidants, iron, and natural nutrients. Traditionally valued for its unique taste and health benefits.",
		...
		metaDescription: "Discover Karuppu Kavuni Rice, a premium black rice rich in antioxidants and natural nutrients for healthy eating.",
		structuredData: {
			"@type": "Product",
			name: "Karuppu Kavuni Rice",
			image: ["https://i.ibb.co/Qj1XZGD5/karuppu-kavuni-rice.png"],
	...
	},
	{
		...
		category: "millets",
		description: "A wholesome traditional red rice rich in fiber, minerals, and natural nutrients. Perfect for healthy everyday meals and traditional South Indian recipes.",
		...
		metaDescription: "Buy Sivappu Arisi, a traditional red rice full of fiber and minerals for healthy everyday South Indian cooking."
	},
	{
